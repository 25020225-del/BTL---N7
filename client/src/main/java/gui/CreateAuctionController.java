...
/**
 * Controller responsible for managing the UI and logic for creating new auctions.
 * <p>
 * This class handles product information input, sets start and end times,
 * and manages image processing (compression and cropping) before transmitting
 * data to the server via the network.
 */
public class CreateAuctionController {
    ...
    @FXML
    private void handleSubmitAuction(javafx.event.ActionEvent event) {
        try {
            ...
            //System.out.println("[Log]: Successfully Created Auction");
            // Reset UI
