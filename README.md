...
- Tuân theo giấy phép mã nguồn mở Apache 2.0, chi tiết xem tại đây: [License](LICENSE)

### Thành viên nhóm:
- Tham khảo -> [Thành viên, công việc](Docs/Works.md)

### Hướng dẫn cài đặt.

- Tham khảo, window  -> [Cài đặt trên window](Docs/WindowsInstall.md)
- Tham khảo, linux -> [Cài đặt trên linux](Docs/LinuxInstall.md)

### Tính năng

- Quản lí chức năng đấu giá theo thời gian thực.
- Mô hình theo server - client.
- Có chức năng đấu giá liên tục
- Có chức năng nạp tiền vào tài khoản.
